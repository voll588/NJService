...
public abstract class AbsRestClient {
	...
	public String baiduserver = SysConfig.getInstance().getProperty("baiduapi");
	 ...
	 * 获取位置信息
	 * @param location 位置坐标
	 * @param output 输出格式xml 或者json
	 * @param pois 是否开启周边服务 1开启 或者0不开启
	 * @return
	 */
	public abstract String getAddress(String location, String output, String pois);
	...
	public StringBuffer getbaiduStringBuffer() {
		StringBuffer sb = new StringBuffer("http://");
		sb.append(baiduserver);
		return sb;
	}
	...
	public HttpResponse get(String cType,String url, DefaultHttpClient httpclient
			) throws Exception {
		HttpGet httppost = new HttpGet(url);	
		httppost.setHeader("Accept", cType);
		HttpResponse response = httpclient.execute(httppost);
