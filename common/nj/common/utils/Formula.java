...
public class Formula {
    ...
    Vector<Integer> paras = new Vector<Integer>();//用来存放变量参数
...
str = Integer.toString(parseLetter(str, paras.get(count)));
    ...
    */
    ...
    public static void main(String[] args) {
	    ...
	    Formula test2 = new Formula();//把两个变量分别替换成4和3再进行计算
	    test2.setFormula("(m+30)");
	    test2.paras.add(600);//为公式里的变量存数据
	    //test2.paras.add(60);//为公式里的变量存数据
	   // test2.paras.add(3);
